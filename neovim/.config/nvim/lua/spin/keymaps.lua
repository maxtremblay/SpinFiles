...
-- Do replace register while pasting in visual mode
keymap("v", "p", '"_dP', opts)
...
keymap("n", "<leader>fc", "<cmd>lua require'telescope.builtin'.commands(require('telescope.themes').get_dropdown({ previewer = false }))<cr>", opts)
